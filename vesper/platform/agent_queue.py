...
class AgentWorkQueue:
    ...
    def complete(self, work_id: str, worker_id: str) -> AgentWorkItem:
        return self._finish(work_id, worker_id, status="completed")

    def renew(
        self, work_id: str, worker_id: str, now: datetime, *, lease_seconds: float
    ) -> AgentWorkItem:
    ...
    def fail(self, work_id: str, worker_id: str) -> AgentWorkItem:
        return self._finish(work_id, worker_id, status="failed")

    def _finish(
        self, work_id: str, worker_id: str, *, status: Literal["completed", "failed"]
    ) -> AgentWorkItem:
